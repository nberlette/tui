...
export const ObjectGetOwnPropertyDescriptor = SafeObject.getOwnPropertyDescriptor;
export const ObjectGetOwnPropertyDescriptors = SafeObject.getOwnPropertyDescriptors;
